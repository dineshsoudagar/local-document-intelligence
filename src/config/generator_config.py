...
GENERATOR_LOAD_PRESETS: dict[str, GeneratorLoadPreset] = {
    "standard": GeneratorLoadPreset(
        key="standard",
        label="Standard",
        description="Baseline loading without bitsandbytes quantization.",
        memory_hint="Baseline VRAM usage. Best baseline compatibility.",
    ...
    "cpu_safe": GeneratorLoadPreset(
        ...
        memory_hint="No GPU VRAM required. Slowest generation path.",
        generator_load_mode="standard",
